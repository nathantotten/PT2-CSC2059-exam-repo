...
public:
	...
	void set_next(T item);		// set pCurrentNode->item to item, move pCurrentNode to pCurrentNode->pNextNode 
	void set_prev(T item);		// set pCurrentNode->item to item, move pCurrentNode to pCurrentNode->pPrevNode
	...
	bool remove(int p1, int p2);	// delete items from postion p1 to p2
